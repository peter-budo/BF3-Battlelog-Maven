...
import com.ninetwozero.battlelog.services.*;
                ...
                if (item.getItemId() == 0) {
                    ...
                    new Intent(
                            ...
                            "profile1", SessionKeeper.getProfileData()
                                    ...
                                    "profile2", UserProfileService.getPersonaIdFromProfile(
                    ...
                    new Intent(
                            ...
                            "profile", UserProfileService.getPersonaIdFromProfile(
    ...
    public class AsyncFeedRefresh extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... arg0) {
            ...
            try {
                ...
                // Get...
                feedArray = FeedsService.getPublicFeed(
    ...
    public class AsyncCOMReload extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... arg0) {
            ...
            try {
                ...
                // Let's get this!!
                notificationArray = NotificationsService.getNotifications(arg0[0]);
                friendListData = FriendsListService.getFriendsCOM(context, arg0[0]);
                platoonArray = PlatoonService.getPlatoonsForUser(context,
